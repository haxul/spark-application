...
object DataFramesBasics extends App {
  ...
  val carsStruct = dataFrame.schema

  val dfOwnSchema = spark.read
    .format("json")
    .schema(carSchema)
    .load("src/main/resources/data/cars.json")
  ...
  val manualCarsWithImplicit = cars.toDF("Name", "MPG", "Cylinders", "Displacement", "HP", "Weight", "Acceleration", "Year", "Country")
  //  manualCarsWithImplicit.show
  ...
  val smartphones = Seq(
    ("CHINA", "HUAWEI 8X", "200x200", "20mpx"),
    ("KOREA", "SAMSUNG A3", "100x200", "20mpx"),
    ("CHINA", "XIAOMI", "202x200", "10mpx"),
    ("CHINA", "IPHONE 11", "200x200", "20mpx"),
  )
  val smartPhonesDF = smartphones.toDF("make", "model", "screen dimension", "camera")
